...
class Dispatcher:
    ...
    def create_message_template(self, text: str = None, attachment: str = None,
                                keyboard: Union[str, Keyboard] = None, forward: dict = None) -> MessageTemplate:
        return MessageTemplate(self.bot, text, attachment, keyboard, forward)

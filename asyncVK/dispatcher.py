...
class Dispatcher:
    def __init__(self, event: dict, event_type: str, bot, text: str = None, user_id: int = None, peer_id: int = None,
                 ...
                 action_member_id: int = None, payload: dict = None, chain_data: Any = None):
    ...
    async def answer(self, text: str = None, attachment: str = None, keyboard: str = None) -> Message:
    ...
    async def reply(self, text: str = None, attachment: str = None, keyboard: str = None) -> Message:
        forward = {
    ...
    async def send_message(self, text: str = None, attachment: str = None, keyboard: str = None) -> Message:
        response = await self.bot.execute("messages.send", message=text, peer_ids=self.peer_id,
                                          random_id=0, attachment=attachment, keyboard=keyboard)
        message_id = response["response"][0]["conversation_message_id"]

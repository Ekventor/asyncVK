...
Возможности диспетчера:
    ...
    dispatcher.answer – ответить в ЛС. Можно активировать при любом событии (отправит сообщение инициатору события (пользователю, запустившего событие)). Список аргументов: 
